...
def insert(win, position):
    ...
    while True:
        for event in pygame.event.get():
            ...
            return
def main():
    global grid, grid_original, dificuldade, solucao, solution, bg_color_dif1, bg_color_dif2, bg_color_dif3, bg_color_dif4, bg_color_dif5, bg_color_dif6, bg_color_dif7, bg_color_dif8, bg_color_dif9
    pygame.init()
