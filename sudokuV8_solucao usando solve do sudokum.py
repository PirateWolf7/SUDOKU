    ...
    while True:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if (retangulo_solucao[0] <= mouse[0] <= retangulo_solucao[0]+retangulo_solucao[2]) and (retangulo_solucao[1] <= mouse[1] <= retangulo_solucao[1]+retangulo_solucao[3]):
                    solucao=1
                    solution = sudokum.solve(grid)
                    print(grid)
                    print(solution)
                    print(solution[1][0][2]) #acede ao terceiro elemento da primeira linha da segunda parte do tuplo
